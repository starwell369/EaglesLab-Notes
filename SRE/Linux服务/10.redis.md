...
![img](10.redis/AYT7998cgpA4Yt0c.png!thumbnail)
...
![img](10.redis/6q9Q4dL4k1B4bALW.png!thumbnail)

- master 节点故障和恢复
  - 需要提升slave为新的master

![img](10.redis/utgv4REQ8esM7XFB.png!thumbnail)

![img](10.redis/5WCkvg1lVxJ1clsU.png!thumbnail)
...
![img](10.redis/BVRaR9baZAnirwIL.png!thumbnail)
...
![img](10.redis/oNOhNXU5ie35HtTL.png!thumbnail)
...
![img](10.redis/JT2hUGtPXKMmaGVi.png!thumbnail)
...
![img](10.redis/TwaDVwGefCFPOd35.png!thumbnail)

![img](10.redis/RMRYYWtrm7ywgqat.png!thumbnail)

![img](10.redis/TcI26Ko6KqcvEmvE.png!thumbnail)

![img](10.redis/Y0xLrAk4P2sygeiu.png!thumbnail)
...
![img](10.redis/Ie2c56MIXXIilQYB.png!thumbnail)

  - 单机器复制风暴 
    - 机器宕机后，大量全量复制 
    - 解决方法：主节点分散多机器

![img](10.redis/mayuxUk0XOwKw9Ac.png!thumbnail)
...
![img](10.redis/jxNPRpsCTtaKHJPz.png!thumbnail)
...
![img](10.redis/i60is15aicT4tOb5.png!thumbnail)

![img](10.redis/USCqSEmA6LTGMcXt.png!thumbnail)
...
![img](10.redis/gjrqcmObJ0eZhFgl.png!thumbnail)
...
![img](10.redis/e3rO18ddctXswGHP.png!thumbnail)

- 由这个sentinel 通过masterName 获取master节点信息

![img](10.redis/G8odMjYSLqb6JOXe.png!thumbnail)

- sentinel 发送role指令确认mater的信息

![img](10.redis/SXEOBz8MjZtKiMre.png!thumbnail)

- 客户端订阅sentinel的相关频道,获取新的master 信息变化,并自动连接新的master

![img](10.redis/Aj7RVlRj1pMaYoFc.png!thumbnail)
...
![img](10.redis/p6L6gWqXd2O2fKzp.png!thumbnail)
...
![img](10.redis/zY9Y6L6yuinssgB5.png!thumbnail)
...
![img](10.redis/VsnE0wiCsR628T0w.png!thumbnail)
...
![img](10.redis/T5WT3ritlz5EQz2F.png!thumbnail)

### Redis Cluster 部署架构说明

- 环境A：3台服务器，每台服务器启动6379和6380两个redis 服务实例，适用于测试环境

![img](10.redis/2peEs1hTL3TFNRtU.png!thumbnail)

- 环境B：6台服务器，分别是三组master/slave，适用于生产环境

![img](10.redis/xgj3dmLhMZY1a2Is.png!thumbnail)
...
![img](10.redis/Bnbx2xF8QUVluZxy.png!thumbnail)
...
![img](10.redis/eQZUMlfFxn0IKszn.png!thumbnail)
